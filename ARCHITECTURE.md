...
flowchart LR
  ...
  API --> P1["Pulsar Topic: persistent://billyronks/sase-sdwan/command"]
  API --> P2["Pulsar Topic: persistent://billyronks/sase-sdwan/event"]
  API --> P3["Pulsar Topic: persistent://billyronks/sase-sdwan/audit"]
  API --> O["Pulsar Topic: persistent://billyronks/global/observability"]
  P1 --> W["Workers / Domain Services"]
  P2 --> W
  P3 --> W
  W --> Q["Quickwit Index: logs-sase-sdwan"]
  API --> Q
```
